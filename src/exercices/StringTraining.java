...
public class StringTraining {
	...
	public static char lastChar(String string) {
		...
		return string.toCharArray()[string.toCharArray().length-1];
	}
	...
	public static int occurrences(String string, char search) {
		char[] lettersInArray = string.toCharArray();
		int numberOfCharactersSearched = 0;
		for (char letter : lettersInArray) {
			if (letter == search) {
				numberOfCharactersSearched ++;
			}
		}

		return numberOfCharactersSearched;
	}
